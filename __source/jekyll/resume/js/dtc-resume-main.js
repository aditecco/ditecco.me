  ...
  $(".page-controls").on("click", ".lang-switcher", function (e) {
    ...
    var buttonHandler = function (label, flagCode) {
      $(".lang-switcher")
        .text(label)
        .next()
        .attr("src", "img/" + flagCode + "-flag.svg");
    };
