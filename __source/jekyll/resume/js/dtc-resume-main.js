			...
			$.map(fullStory, function(e, i) {
				...
				var localized = [
					...
					},
					{
						...
						body: '<p>Mi occupo stabilmente di UI Design dal 2011, e dal 2015 ho deciso di dare un nome alla mia attivit&agrave;: l&#39;ho chiamata Simplest, per ricordare a me stesso che le interfacce utente e le interazioni pi&ugrave; semplici sono il fondamento delle migliori esperienze digitali.</p><p>Negli ultimi 6 anni ho progettato una vasta gamma di prodotti digitali, spesso curandone l&#39;immagine completa dall&#39;identit&agrave; al marketing: subscription e-commerce, web apps, applicazioni multi-piattaforma, &amp; molto altro. <a href="http://www.simplest.io/?ref=dtc-resume">&rarr; Tutti i miei lavori</a></p><p>Inoltre, data la mia passata esperienza nella creazione e gestione di uno spazio di coworking, ho sviluppato una comprensione a tutto tondo del ciclo di vita di un prodotto: progettazione (nell&#39;ambito fisico o digitale), marketing &amp; vendita, pricing, amministrazione, acquisizione clienti, fidelizzazione, customer care, e tutte le quotidiane attivit&agrave; di problem-solving che ogni imprenditore conosce bene.</p>'
					},
					{
						title: '2013 - 2016 &mdash; Geekville',
						jobTitle: 'Creatore, Co-Founder, Designer',
						body: '<p>Attivo da ottobre 2013, Geekville &egrave; il coworking per aziende e freelance del settore creativo, web, &amp; mobile a Verona. <a href="/archive/geekville/">Visita il sito</a></p><p>Ispirato agli uffici delle startup di Silicon Valley, Geekville &egrave; un ambiente di lavoro non convenzionale: offre tutto ci&ograve; che serve per essere produttivi, e allo stesso tempo favorisce l&#39;incontro e lo scambio di conoscenze tra coworkers grazie all&#39;atmosfera amichevole e informale.</p><p>Geekville &egrave; attivo anche nella produzione di corsi &amp; workshop, con il brand Geekville Learning.</p><p>Credits: Geekville &egrave; stato fondato e realizzato col fondamentale aiuto del mio socio Francesco Adami, con il quale attualmente sto gestendo la societ&agrave;.</p>'
					},
					{
						title: '2012 - 2013 &mdash; The Collective',
						jobTitle: 'Creatore, Co-Founder, Designer',
						body: '<p>Nel 2012 a Verona non esisteva una vera e propria offerta dedicata al coworking; certo, c&#39;era abbondanza di professionisti e aziende con uffici pi&ugrave; grandi del necessario, che per arrotondare affittavano qualcuno dei loro locali. Ma ho sempre pensato che questo non si potesse chiamare coworking; piuttosto, sub-affitto.</p><p>Nessuno aveva ancora pensato di creare una realt&agrave; che facesse una cosa sola, e con la massima qualit&agrave;: offrire spazi di lavoro come servizio per giovani aziende e professionisti, a un prezzo ragionevole. E&#39; in questo vuoto che si &egrave; inserito <a href="/archive/the-collective/">The Collective.</a></p><p>Durante la sua esistenza, in molti si sono incontrati a The Collective: alcuni hanno instaurato rapporti professionali, altri sono diventati semplicemente buoni amici. Alcuni ne hanno fatto quasi una seconda casa, altri ci hanno trovato lo spazio giusto per dare vita a quei progetti che da troppo tempo tenevano nel cassetto. Altri ancora si sono ispirati a The Collective per creare un proprio coworking. In ogni caso, The Collective ha lasciato il segno.</p><p>Credits: un fondamentale aiuto nel realizzare e gestire The Collective &egrave; venuto dal mio socio Francesco Adami, con il quale attualmente conduco Geekville.</p>'
					},
					{
