		...
		if (checkLang === 'English version') {
			...
			$.map(quickOutline, function(e, i) {
				...
				var localized = [
					...
					{
						title: 'Profilo',
						body: '<li><h3 class="list-heading">Front-End Developer</h3>Sviluppo layout e interfacce web &amp; mobile, con i pi&ugrave; recenti standard CSS e JavaScript.</li><li><h3 class="list-heading">Design background</h3>Dal 2011 al 2016 ho creato UI Design per una vasta gamma di prodotti digitali.</li>'
					},
					{
						title: 'Skills',
						body: ''
			...
			$.map(fullStory, function(e, i) {
				...
				var localized = [
					...
					{
						title: '2018 - Oggi &mdash; Fornace',
						jobTitle: 'Front-End Developer',
						body: '<p>In Fornace sviluppo layout e interfacce web &amp; mobile, con i pi&ugrave; recenti standard CSS e JavaScript. Il tipo di lavoro spazia da piccoli brochure-sites con CMS a grandi applicazioni enterprise in React. Talvolta mi occupo anche, per progetti selezionati, del design UI/UX.</p>'
					},
					{
